-- ============================================================
-- Note from us : We came across two errors while populating the database so we fixed the errors 
-- in this ddl file. Kindly check this file,both the errors has been commented. We had a word with Kahan Bhai too and 
-- he approved to resubmit the ddl file.
-- ============================================================
-- ============================================================
-- 1. VENDOR
-- ============================================================
...
hotel_id INT REFERENCes HOTEL(hotel_id) on delete cascade ,-- FIX : added the foreign key
